...
aliases:
  - /blog/find-file-under-cursor-in-emacs/
  - /til/find-file-under-cursor-in-emacs/
---

=#TIL= you can use =gf= to open a file under the current cursor position in VIM, I was reading this [[https://thevaluable.dev/vim-advanced/][post]] I found on Hacker News and I was wondering if =evil-mode= has this functionality as well
...
[[file:/images/posts/find-file-under-cursor-in-emacs/demo.gif]]
