...
type: posts
aliases:
  - /blog/creating-an-emacs-formatter-the-easy-way/
---

Some weeks ago I discovered a really nice package for emacs called [[https://github.com/purcell/reformatter.el][reformatter.el]]. This package allows you to define reformat functions in an easy way.
...
Also we can set up Emacs to run the formatter when the file is saved, for example put this code in your =.dir-locals.el= and it will do the work.
...
This package is very useful if you don't want to install an external package just for formatting. I replaced =hindent-mode= (haskell formatter) and a custom elixir formatter with this package. Also this package is used in =elm-mode= package.
