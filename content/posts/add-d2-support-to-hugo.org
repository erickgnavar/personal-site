...
tags: [ hugo, d2 ]
aliases:
  - /blog/add-d2-support-to-hugo/
---

[[https://d2lang.com][D2]] is a declarative language to generate diagrams, it's like mermaid on steroids, it has a ~cli~ so it's easy to use.
...
This server only uses the standard library and does the following:
...
[[file:/images/posts/add-d2-support-to-hugo/render-post-result.png]]
...
~Hugo~ allows us to add custom features to our site and ~Go~ allows us to accomplish tasks using only the standard library.
