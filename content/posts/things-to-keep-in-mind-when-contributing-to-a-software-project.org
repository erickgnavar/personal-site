...
aliases:
  - /blog/things-to-keep-in-mind-when-contributing-to-a-software-project/
---

These are some thoughts to keep in mind when we're contributing to a software project.
...
#+begin_quote
Friends don't let friends use =git add .=
#+end_quote

The tool you use to stage changes and then commit should allow you to stage chunks of code one by one. This way you can review what you are adding. You don't want to commit those debug messages or commented code that you were using while you're working on the project. Or even worse you definitely don't want to commit credentials files.
...
- Check the commits you've made. Maybe you can clean the log a little bit, remove some =WIP= commits or improve some messages.
...
If someone rewrites or deletes some code that you wrote, it doesn't necessarily mean it was "bad code" or something like that — maybe the requirement was different back then. Code has to evolve, and at the end what matters most is that the application does what it is supposed to do. Also, in some cases you'll be the one refactoring or fixing your own code a while after it was written ;)
