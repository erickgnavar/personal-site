...
aliases:
  - /blog/simple-obs-client-in-elixir/
---
...
First we need to install a websocket client, [[https://hex.pm/packages/fresh][fresh]] is an easy-to-use client that works on top of [[https://hex.pm/packages/mint][mint]].
