...
tags: [emacs, mermaid]
aliases:
  - /blog/mermaid-preview-using-xwidget-browser/
...
There are some options to do that but they require [[https://github.com/mermaid-js/mermaid-cli][mermaid-cli]] to be installed, which requires ~nodejs~ as well.

Emacs has a built-in webkit browser, in case it was compiled with ~--with-xwidgets~ flag, and Mermaid runs on JS so it should be possible to just run the code I want in the browser and see it there.
...
[[file:/images/posts/mermaid-preview-using-xwidget-browser/mermaid-preview.gif]]
