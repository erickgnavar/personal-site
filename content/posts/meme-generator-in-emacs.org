...
#+CAPTION: Pick meme
#+NAME: fig:pick-meme
[[file:/images/posts/meme-generator-in-emacs/pick-meme.png]]

And then we can add some text to it, like the image below:

#+CAPTION: Adding text
#+NAME: fig:adding-text
[[file:/images/posts/meme-generator-in-emacs/edit-text.png]]
